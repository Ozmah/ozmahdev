...
type PageContainerVariant = "contact" | "full" | "home" | "wide" | "wider";
...
const pageContainerVariants: Record<PageContainerVariant, string> = {
	contact:
		"mx-auto min-h-dvh w-full max-w-5xl bg-background px-5 py-10 text-foreground sm:px-8 sm:py-14 lg:px-0 lg:py-20",
