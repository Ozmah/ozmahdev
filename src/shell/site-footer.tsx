...
export function SiteFooter() {
	...
	const isAperture = pathname === "/aperture";
	const isPrivacy = pathname === "/privacy";

	return (
		<footer className="px-5 sm:px-8 lg:px-0">
			<div className="mx-auto flex min-h-20 w-full max-w-5xl items-center justify-between gap-4">
				...
				{isPrivacy ? null : (
					<div className="flex items-center gap-2">
						<Link
							className="px-2 py-3 font-oz-mono text-dim text-xs tracking-[0.08em] no-underline transition-colors duration-150 ease-out hover:text-accent focus-visible:text-accent"
							to="/privacy"
						>
							privacy
						</Link>
