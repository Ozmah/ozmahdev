...
export type CoercedEnvSchema = {
  /**
   * **APP_ENV**  
   * Application environment used by Varlock to select environment-specific files.  
  ...
  /**
   * **VITE_POSTHOG_KEY**  
   * Public PostHog project token embedded into the browser bundle.  
  ...
  /**
   * **VITE_POSTHOG_HOST**  
   * PostHog ingestion host. The project token must belong to this region.  
...
type _CoercedEnvSchema_4b58701a = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_4b58701a> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_4b58701a, 'APP_ENV' | 'VITE_POSTHOG_KEY' | 'VITE_POSTHOG_HOST'>> {}
}
...
type _EnvSchemaAsStrings_4b58701a = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_4b58701a {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_4b58701a {}
  }
}